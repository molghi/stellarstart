    ...
    <section class="work-top">
        <div class="container">
            <div class="work-top__wrapper">
                <div class="work-top__sup-title">{{ content.topTitle }}</div>
                <div class="work-top__title">{{ content.title }}</div>
                <div class="work-top__text">
                    {{ content.subtitle }}
                </div>
                <div class="work-top__social">
                    <a
                        v-for="(item, index) in content.socials"
                        :key="index"
                        :href="item.link"
                        class="work-top__social-link"
                        v-html="item.icon"
                    >
                    </a>
                </div>
...
.work-top__social-link {
    transition: all 0.3s;
}
.work-top__social-link + .work-top__social-link {
    margin-left: 28px;
}
.work-top__social-link:hover {
    opacity: 0.5;
}
